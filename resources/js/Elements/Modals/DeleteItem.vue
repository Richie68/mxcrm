...
<template>
  <TransitionRoot as="template" :show="open">
    <Dialog as="div" class="fixed z-10 inset-0 overflow-y-auto" @close="closeIt()">
              ...
              <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                ...
                <div class="mt-2">
                  <p class="text-sm text-gray-500">
                    ¿Está seguro(a) de querer eliminar el Registro? <br>
                    En algunos casos, ya no se podrá recuperar. <br>
                    Si tienes dudas consulta con el área de Desarrollo Web de Transcabo.
                  </p>
                </div>
              </div>
            </div>
