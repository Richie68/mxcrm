          ...
          <div class="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
            <div>
              <div
                ...
                :class="{'bg-green-100': details.type == 'success', 'bg-red-200': details.type == 'error', 'bg-yellow-200': details.type == 'warning'}"
              >
                <CheckIcon class="h-6 w-6 text-green-600" aria-hidden="true" v-if="details.type == 'success'" />
                <XIcon class="h-6 w-6 text-red-600" aria-hidden="true" v-if="details.type == 'error'" />
                <ExclamationIcon class="h-6 w-6 text-yellow-600" aria-hidden="true" v-if="details.type == 'warning'" />
              </div>
              <div class="mt-3 text-center sm:mt-5">
                ...
                <div class="mt-2">
                  <p class="text-sm text-gray-500" v-html="details.message"></p>
                </div>
              </div>
            </div>
...
const details = ref(props.attributes)
